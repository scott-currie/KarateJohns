...
class Player(pygame.sprite.Sprite):
	...
	def __init__(self):
		...
		self.image_0 = pygame.image.load(os.path.join('resources/graphics', 'john00.png'))			# 0  : idle right 1
		self.image_1 = pygame.image.load(os.path.join('resources/graphics', 'john01.png'))			# 1  : idle right 2 
		self.image_2 = pygame.image.load(os.path.join('resources/graphics', 'john02.png'))			# 2  : punch right 1
		self.image_3 = pygame.image.load(os.path.join('resources/graphics', 'john03.png'))			# 3  : punch right 2 
		self.image_4 = pygame.image.load(os.path.join('resources/graphics', 'john04.png'))			# 4  : kick right 1 
		self.image_5 = pygame.image.load(os.path.join('resources/graphics', 'john05.png'))		    # 5  : kick right 2
		self.image_6 = pygame.image.load(os.path.join('resources/graphics', 'john06.png'))			# 6  : idle left 1 
		self.image_7 = pygame.image.load(os.path.join('resources/graphics', 'john07.png'))			# 7  : idle left 2
		self.image_8 = pygame.image.load(os.path.join('resources/graphics', 'john08.png'))			# 8  : punch left 1
		self.image_9 = pygame.image.load(os.path.join('resources/graphics', 'john09.png'))          # 9  : punch left 2
		self.image_10 = pygame.image.load(os.path.join('resources/graphics', 'john10.png'))			# 10 : kick left 1
		self.image_11 = pygame.image.load(os.path.join('resources/graphics', 'john11.png'))			# 11 : kick left 2
		self.image_12 = pygame.image.load(os.path.join('resources/graphics', 'john12.png'))			# 12 : walk right
		self.image_13 = pygame.image.load(os.path.join('resources/graphics', 'john13.png'))			# 13 : walk left
		self.image_14 = pygame.image.load(os.path.join('resources/graphics', 'john14.png'))			# 14 : reel right
		self.image_15 = pygame.image.load(os.path.join('resources/graphics', 'john15.png'))			# 15 : reel left
		
		self.images = [self.image_0, self.image_1, self.image_2, self.image_3, self.image_4, self.image_5, self.image_6, self.image_7, self.image_8, self.image_9, self.image_10, self.image_11, self.image_12, self.image_13, self.image_14, self.image_15]
		...
		#----Punches
		self.anim_punch_right = [self.images[2], self.images[3], self.images[3], self.images[2]]
		self.anim_punch_left = [self.images[8], self.images[9], self.images[9], self.images[8]]
		#----Kicks
		self.anim_kick_right = [self.images[4], self.images[4], self.images[5], self.images[5], self.images[5], self.images[4], self.images[4]]
		self.anim_kick_left = [self.images[10], self.images[10], self.images[11], self.images[11], self.images[11], self.images[10], self.images[10]]		
		#----Reels
		self.anim_reel_right = [self.images[14], self.images[14], self.images[14], self.images[14]]
		self.anim_reel_left = [self.images[15], self.images[15], self.images[15], self.images[15]]		

		#--Load sound
		self.snd_kick = pygame.mixer.Sound(os.path.join('resources/sounds', 'kick3.ogg'))	
		self.snd_punch = pygame.mixer.Sound(os.path.join('resources/sounds', 'punch3.ogg'))	
		...
		#--Walk animation
			...
			if self.facing == 0:
				if self.animation_timer <= 3:
					...
					image = self.images[13]
			elif self.facing == 1:

				if self.animation_timer <= 3:
					image = self.images[0]
				else:
					image = self.images[12]
		#--Return idle image
		elif self.idle:
			if self.facing == 0:
				if self.animation_timer <= 3:
	...
	def update(self, keys, enemy):
		...
		if self.punch or self.kick:
			#If attack timer has not reached upper limit for animation frames, increment attack timer
			if (self.punch and self.attack_timer < len(self.anim_punch_right) - 1) or (self.kick and self.attack_timer < len(self.anim_kick_right) - 1):
				self.attack_timer += 1
			#Otherwise, clear attack status and attack_timer
			else:
				self.attack_timer = 0
				self.punch = False
				self.kick = False
			...
			if self.reel_timer < len(self.anim_reel_right) - 1:
				self.reel_timer += 1
			else:
				self.reel_timer = 0
				self.reel = False
