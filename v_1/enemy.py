...
class Enemy(pygame.sprite.Sprite):
	...
	def __init__(self):
		...
		self.anim_fall_left = [self.images[16], self.images[17], self.images[17], self.images[17], self.images[17], self.images[17], self.images[17], self.images[17], self.images[17], self.images[17], self.images[17], self.images[17], self.images[17], self.images[17]]
